...
seleccion = limit datos 10;
salida = FOREACH seleccion GENERATE driverId,truckId,eventTime;
salida_ordenada = ORDER salida BY driverId,truckId,eventTime;

STORE salida_ordenada INTO 'output/' using PigStorage(',');
